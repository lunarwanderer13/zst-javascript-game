...
If you don't already have yarn: `npm install yarn --global` (if you don't have npm either, use [this guide](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm)  
`yarn install`  
